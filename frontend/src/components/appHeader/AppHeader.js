                    ...
                    <div className="d-flex flex-wrap justify-content-between align-items-center col-12">
                        ...
                        <div className="collapse navbar-collapse mt-3 mt-lg-0 justify-content-end" id="navbarNav">
                            <ul className="navbar-nav align-items-center justify-content-between col-12 col-lg-10 col-xxl-7">
                                ...
                                <li className="col-12 col-lg-1 my-2"><Link to="/main#services" className="col-12 text-start text-lg-center" href="#services">Услуги</Link></li>
                                ...
                                <li className="col-12 col-lg-1 my-2"><Link to="/main#locations" className="col-12 text-start text-lg-center" href="#locations">Локации</Link></li>
                                ...
                                <li className="d-block d-lg-none my-2 col-12" onClick={() => {window.scrollTo(0, 0)}} style={{cursor: "pointer"}}><Link style={{fontWeight: 600}} to="/user-info" class="dropdown-item">Личный кабинет</Link></li>
                                <li className="d-block d-lg-none my-2 col-12" onClick={() => {window.scrollTo(0, 0)}} style={{cursor: "pointer"}}><Link style={{fontWeight: 600}} to="/" class="dropdown-item text-danger">Выйти<i class="bi fa-lg bi-box-arrow-right ms-1"></i></Link></li>
                                ...
                                <li className="d-none d-lg-block my-2">
                                    <div class="dropdown">
                                        ...
                                        <ul style={{boxShadow: "0px 10px 15px 0px rgba(0, 0, 0, 0.25)"}} className="dropdown-menu dropdown-menu-end mt-2 p-3" aria-labelledby="dropdown-user">
                                            <li onClick={() => {window.scrollTo(0, 0)}} style={{cursor: "pointer"}}><Link style={{fontWeight: 500}} to="/user-info" className="dropdown-item my-1">Личный кабинет</Link></li>
                                            <li onClick={() => {window.scrollTo(0, 0)}} style={{cursor: "pointer"}}><Link style={{fontWeight: 500}} to="/" className="dropdown-item text-danger my-1">Выйти<i class="bi fa-lg bi-box-arrow-right ms-1"></i></Link></li>
                                        </ul>
                                    </div>
                                </li>                    
                            </ul>
                ...
                <div className="d-flex flex-wrap justify-content-between align-items-center col-12">
                    ...
                    <div className="collapse navbar-collapse mt-3 mt-lg-0 justify-content-end" id="navbarNav">
                        <ul className="navbar-nav align-items-center justify-content-between col-12 col-lg-11 col-xxl-6">
                            ...
                            <li className="d-block d-lg-none my-2 col-12" onClick={() => {window.scrollTo(0, 0)}} style={{cursor: "pointer"}}><Link style={{fontWeight: 600}} to="/main" class="dropdown-item">Главная страница</Link></li>
                            <li className="d-block d-lg-none my-2 col-12" onClick={() => {window.scrollTo(0, 0)}} style={{cursor: "pointer"}}><Link style={{fontWeight: 600}} to="/" class="dropdown-item text-danger">Выйти<i class="bi fa-lg bi-box-arrow-right ms-1"></i></Link></li>
                            ...
                            <li className="d-none d-lg-block my-2">
                                <div class="dropdown">
                                    ...
                                    <ul style={{boxShadow: "0px 10px 15px 0px rgba(0, 0, 0, 0.25)"}} className="dropdown-menu dropdown-menu-end mt-2 p-3" aria-labelledby="dropdown-user">
                                        <li style={{cursor: "pointer"}}><Link onClick={() => {window.scrollTo(0, 0)}} style={{fontWeight: 500}} to="/main" class="dropdown-item">Главная страница</Link></li>
                                        <li style={{cursor: "pointer"}}><Link onClick={() => {window.scrollTo(0, 0)}} style={{fontWeight: 500}} to="/" className="dropdown-item text-danger my-1">Выйти<i class="bi fa-lg bi-box-arrow-right ms-1"></i></Link></li>
                                    </ul>
                                </div>
                            </li>                    
                        </ul>
